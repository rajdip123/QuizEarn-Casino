  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#050505]/90 backdrop-blur-md border-t border-white/5 pb-safe">
      <div className="max-w-[1280px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <button onClick={() => setActiveTab('games')} className={`flex flex-col items-center gap-1 ${['games', 'slot', 'wheel', 'coin_flip'].includes(activeTab) ? 'text-amber-400' : 'text-white/40 hover:text-white/70'}`}>
